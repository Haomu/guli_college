...
import pers.sunny.aclservice.entity.Permission;
import pers.sunny.aclservice.entity.RolePermission;
import pers.sunny.aclservice.entity.User;
import pers.sunny.aclservice.helper.MemuHelper;
import pers.sunny.aclservice.helper.PermissionHelper;
import pers.sunny.aclservice.mapper.PermissionMapper;
import pers.sunny.aclservice.service.PermissionService;
import pers.sunny.aclservice.service.RolePermissionService;
    ...
    public static List<Permission> bulidPermission(List<Permission> permissionList) {
        ...
        for (Permission permission : permissionList) {
            if ("0".equals(permission.getPid())){
                ...
                //根据顶层菜单，向里面进行查询子菜单，封装到finalNode里
